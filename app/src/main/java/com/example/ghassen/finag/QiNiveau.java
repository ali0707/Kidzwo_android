...
public class QiNiveau extends AppCompatActivity {
    ...
    private void init() {
        ...
        rep1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if(User.scoreqi < 15 && extras.getString("niveau").equals("Niveau1"))
                    {
                        User.scoreqi+=5;
                        score.setText("Score: "+ User.scoreqi);
                    ...
                    else if(User.scoreqi < 30 && extras.getString("niveau").equals("Niveau2"))
                    {
                        User.scoreqi+=5;
                        score.setText("Score: "+ User.scoreqi);
                    ...
                    else if(User.scoreqi < 45 && extras.getString("niveau").equals("Niveau3"))
                    {
                        User.scoreqi+=5;
                        score.setText("Score: "+ User.scoreqi);
                    ...
                    else if(User.scoreqi < 60 && extras.getString("niveau").equals("Niveau4"))
                    {
                        User.scoreqi+=5;
                        score.setText("Score: "+ User.scoreqi);
    ...
    public void suivant(final TextView enonce, final Button rep1, final Button rep2, final Button rep3, final Button rep4){
        ...
        {
            Toast.makeText(getApplicationContext(), "wfewww", Toast.LENGTH_LONG).show();
            Intent retour = new Intent(QiNiveau.this,Qi.class);
    ...
    public void verifScore()
    {
        ...
        else if (User.scoreqi == 30)
        {
            MyCustomAlertDialog();
        }
        else if (User.scoreqi == 45)
        {
            MyCustomAlertDialog();
        }
    ...
    public void MyCustomAlertDialog(){
        final Dialog MyDialog = new Dialog(QiNiveau.this);
